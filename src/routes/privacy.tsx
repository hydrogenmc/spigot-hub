...
export const Route = createFileRoute("/privacy")({
  head: () => ({ meta: [{ title: "Privacy Policy — CubynDev" }, { name: "description", content: "Privacy Policy" }] }),
  component: () => (
    <div className="min-h-screen">
      ...
      <section className="mx-auto max-w-3xl px-4 py-20 sm:px-6">
        ...
        <div className="glass mt-8 space-y-4 rounded-2xl p-8 text-sm leading-relaxed text-muted-foreground">
          <p><strong className="text-foreground">No Tracking.</strong> CubynDev does not require an account and does not track individual visitors.</p>
