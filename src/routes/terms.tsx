...
export const Route = createFileRoute("/terms")({
  head: () => ({ meta: [{ title: "Terms of Service — CubynDev" }, { name: "description", content: "Terms of Service" }] }),
  component: () => (
    <div className="min-h-screen">
      ...
      <section className="mx-auto max-w-3xl px-4 py-20 sm:px-6">
        ...
        <div className="glass mt-8 space-y-4 rounded-2xl p-8 text-sm leading-relaxed text-muted-foreground">
          <p><strong className="text-foreground">1. Acceptance.</strong> By accessing CubynDev you agree to these terms.</p>
          ...
          <p><strong className="text-foreground">3. Attribution.</strong> Original resource authors retain all rights to their work. CubynDev serves as a distribution platform.</p>
